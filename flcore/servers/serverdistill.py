...
class FedDistill(Server):
    ...
    def train(self):
        for i in range(self.global_rounds+1):
            ...
            if i > 1:
                _, download_cost = load_item('Server', 'global_logits', self.save_folder_name, get_size=True)
    ...
    def receive_logits(self):
        ...
        for client in self.selected_clients:
            ...
            logits, size = load_item(client.role, 'logits', client.save_folder_name, get_size=True)
            upload_cost += size
