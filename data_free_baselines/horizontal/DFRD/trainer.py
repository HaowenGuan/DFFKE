...
class ClientTrainer:
    def __init__(self, args, client_id):
        ...
        self.train_dataloader = args.data_distributer.get_client_train_loader(client_id)
        ...
        self.test_dataloader = args.data_distributer.get_client_test_loader(client_id)
