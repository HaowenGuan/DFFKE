...
class ClientTrainer:
    def __init__(self, args, client_id):
        ...
        self.train_dataloader = args.data_distributor.get_client_train_loader(client_id)
        self.train_batch_data_iter = CycleDataloader(self.train_dataloader)
        self.train_label_list = args.data_distributor.get_client_label_list(client_id)
        # self.test_dataloader = args.data_distributor.get_client_test_dataloader(client_id)
        self.test_dataloader = args.data_distributor.get_test_loader()
