...
import numpy as np
import torch
from experiments.datasets.data_distributer import DataDistributor
...
def get_args():
    ...
    parser.add_argument('--data_set', type=str, default='CIFAR10',
                        choices=['MNIST', 'FMNIST', 'CIFAR10', 'CIFAR100', 'SVHN', 'FOOD101', 'Tiny-Imagenet'])
    ...
    args.data_distributer = _get_data_distributor(args)
